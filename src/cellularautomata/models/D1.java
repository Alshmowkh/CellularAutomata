package cellularautomata.models;

import java.util.concurrent.TimeUnit;

/**
 * Implementation the simplest class of one-dimensional cellular automata.
 * Elementary cellular automata have two possible values for each cell (0 or 1),
 * and rules that depend only on nearest neighbor values. As a result, the
 * evolution of an elementary cellular automaton can completely be described by
 * a table specifying the state a given cell will have in the next generation
 * based on the value of the cell to its left, the value the cell itself, and
...
public class D1 {
     ...
     */
    public D1(int size, int rule, Boolean boundaryValue, Boolean displayFlag) {
